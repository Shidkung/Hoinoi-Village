...
int main() {
	...
	player player(&playerTexture, sf::Vector2u(4, 7), 0.2f, 150.0f);
	...
	sf::Texture Housetext;
	Housetext.loadFromFile("png/campping.png");
	Platform House(&Housetext, sf::Vector2f(850.0f, 500.0f), sf::Vector2f(1920.0f / 12, 1080.0f/1.6));
